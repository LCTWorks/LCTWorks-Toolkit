...
public record class HtmlMetaTags
{
    ...
    public string? ArticlePublishedTime
    {
        get; init;
    }
    public string? ArticleModifiedTime
    {
        get; init;
    }
    ...
    public string? AppleMobileWebAppStatusBarStyle
    {
        get; init;
    }
    ...
    public string? GetSiteName()
        => SiteName ?? OgSiteName ?? ApplicationName ?? AppleMobileWebAppTitle;
}